...
func TestAccDataSourceAlerts_basic(t *testing.T) {
	dataSourceName := "data.jumpcloud_alerts.test"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccJumpCloudDataSourceAlertsConfig_basic(),
...
func TestAccDataSourceAlerts_filtered(t *testing.T) {
	dataSourceName := "data.jumpcloud_alerts.filtered"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccJumpCloudDataSourceAlertsConfig_filtered(),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet(dataSourceName, "total_count"),
				),
			},
